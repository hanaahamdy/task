      ...
      children: [
        ...
        Positioned(
          ...
          child: CustomizedTextField(
            contentPadding: EdgeInsets.symmetric(vertical: AppPadding.pH16),
            ...
            suffixWidget: Text("  :${index + 1} ${AppStrings.playerNumber}", style: TextStyle(color: ColorManager.black, fontSize: FontSize.s12),),
            suffixIcon: const Icon(Icons.camera_rear_sharp),
